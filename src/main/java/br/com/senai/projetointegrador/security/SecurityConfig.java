    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtFilter) {
        return http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers(HttpMethod.POST, "/courses/*/students").hasRole("ADMINISTRATIVE_TEACHER")
                        .requestMatchers(HttpMethod.POST, "/students").hasRole("ADMINISTRATIVE_TEACHER")
                        .requestMatchers(HttpMethod.POST, "/incidents").hasRole("TEACHER")
                        .requestMatchers(HttpMethod.GET, "/incidents").hasAnyRole("QUALITY_ANALYST", "COORDINATOR")
                        .requestMatchers(HttpMethod.GET, "/incidents/*").hasAnyRole("QUALITY_ANALYST", "COORDINATOR")
